insert into USUARIOS (id_usuario, username, password, role)
...
insert into CLIENTES (id_cliente, nome, cpf, id_usuario) values (21, 'Biatriz Rodrigues', '09191773016', 101);
insert into CLIENTES (id_cliente, nome, cpf, id_usuario) values (22, 'Rodrigo Silva', '98401203015', 102);

insert into vagas (id_vaga, codigo, status) values (100, 'A-01', 'OCUPADA');
insert into vagas (id_vaga, codigo, status) values (200, 'A-02', 'OCUPADA');
insert into vagas (id_vaga, codigo, status) values (300, 'A-03', 'OCUPADA');
insert into vagas (id_vaga, codigo, status) values (400, 'A-04', 'LIVRE');
insert into vagas (id_vaga, codigo, status) values (500, 'A-05', 'LIVRE');
